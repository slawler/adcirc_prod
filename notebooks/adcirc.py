...
class adcirc:
    ...
    def plot_surf_dir(grp,lat1,lat2,lon1,lon2):
        ...
        ax1.add_patch(FancyArrowPatch([0.5,0.76],[0.5,0.95],shrinkA=0,shrinkB=0,arrowstyle='simple',color='k',mutation_scale=40))
        ax1.add_patch(FancyArrowPatch([0.6,0.75],[0.68,0.95],shrinkA=0,shrinkB=0,arrowstyle='simple',color='k',mutation_scale=40))
        ax1.add_patch(FancyArrowPatch([0.63,0.63],[0.76,0.76],shrinkA=0,shrinkB=0,arrowstyle='simple',color='k',mutation_scale=40))
        ax1.add_patch(FancyArrowPatch([0.65,0.5],[0.8,0.5],shrinkA=0,shrinkB=0,arrowstyle='simple',color='k',mutation_scale=40))
        ax1.add_patch(FancyArrowPatch([0.63,0.3],[0.76,0.17],shrinkA=0,shrinkB=0,arrowstyle='simple',color='k',mutation_scale=40))        
